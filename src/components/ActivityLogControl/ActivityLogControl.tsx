            ...
            {displayedEntries.map((entry, idx) => (
              <div key={entry.id} className={`alc-entry ${idx === displayedEntries.length - 1 && !hasMore ? 'last' : ''}`}>
                ...
                <div className="alc-entry-right">
                  ...
                  <div className={`alc-entry-body${entry.operation === 'FIELD_UPDATE' || entry.operation === 'ACCELERATION_APPLIED' || entry.operation === 'WORKFLOW_ACTION_APPLIED' ? ' alc-entry-body--bare' : ''}`}>
